...
#This code is obtained from VGGish then adapted to the project.
#ref https://github.com/tensorflow/models/blob/master/research/audioset/vggish/mel_features.py
